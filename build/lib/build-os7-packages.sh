...
build_os7_module() {
	...
	for name in Zfs Net Time Systemd Directory Hardware OS7; do
	...
	pkg_finish   os7-module "${stage}" all \
		...
		./usr/local/share/powershell/Modules/OS7/OS7.RemoteDesktop.ps1 \
		./usr/local/share/powershell/Modules/OS7/OS7.AccountLockout.ps1 \
		...
		./usr/local/share/powershell/Modules/Hardware/Hardware.psm1
}
