...
| `Remove-DirectoryRealm` | Leave a realm: delete the computer account, the keytab, and the cached identities the realm put on this host. | **Domain**, UserName, Password, KeytabPath, SssdConfPath, CacheDirectory |
...
| `Add-OS7RemoteDesktopUser` | Let an account sign in over Remote Desktop. | **Name** |
...
| `Test-OS7RemoteDesktop` | Check the Remote Desktop configuration on this machine, one question at a time. | *keine* |
